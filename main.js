...
const student1 = new Student("dua", 22, "student1");
// student1.registerForCourses("Metaverse")
// console.log(student1.courses)
const student2 = new Student("fajur", 22, "student2");
console.log(student1);
const instructor1 = new Instructor("inaya", 22, 100000);
...
const instructor2 = new Instructor("aayat", 22, 900000);
